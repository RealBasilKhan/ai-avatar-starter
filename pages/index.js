...
import typeSkipLogo from "../assets/typeskip-logo.png";
...
const Home = () => {
  ...
  return (
    <div className="root">
      <Head>
        <title>AI Avatar Generator | TypeSkip</title>
      </Head>
      ...
      <div className="badge-container grow">
        <a href="https://www.typeskip.ai" target="_blank" rel="noreferrer">
          <div className="badge">
            <Image src={typeSkipLogo} alt="TypeSkip logo" />
            <p>TypeSkip AI</p>
          </div>
        </a>
      </div>
